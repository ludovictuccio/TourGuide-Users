...
public class UserControllerIT {
    ...
    private static final String URI_GET_USERDTO = "/user/getUserDto/internalUser1";
    ...
    private static final String URI_TEST_ADD_REWARDS = "/user/testAddUserRewardsPoints";
    ...
    @Test
    @Tag("testAddUserRewardsPoints")
    @DisplayName("testAddUserRewardsPoints - Ok")
    public void givenUser_whenAddREwardsForTEst_thenReturnOK()
            throws Exception {
        User user = new User(UUID.randomUUID(), "internalUser1", "000",
                "jon@tourGuide.com");
        internalUserRepository.internalUserMap.put("internalUser1", user);
        this.mockMvc
                .perform(get(URI_TEST_ADD_REWARDS)
    ...
    @Test
    @Tag("getUserDto")
    @DisplayName("Get user dto - Ok")
    public void givenUserDto_whenGetWhithHisUsername_thenReturnOk()
            throws Exception {
        userService.addUser(new User(UUID.randomUUID(), "internalUser1", "000",
                "jon@tourGuide.com"));
        this.mockMvc
                .perform(MockMvcRequestBuilders.get(URI_GET_USERDTO)
                        .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk()).andDo(MockMvcResultHandlers.print())
                .andExpect(status().isOk()).andReturn();
    }
